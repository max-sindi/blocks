  ...
  services: [
    {
      ...
      picture: {
        resourceRef: 'Depositphotos_146804477_original.png',
    ...
    },
    {
      ...
      picture: {
        resourceRef: 'Depositphotos_150504326_original.png',
        alt: 'Service illustration photo',
      },
      cta: {
        actionConfig: {
    ...
    },
    {
      ...
      picture: {
        resourceRef: 'Depositphotos_159638720_original.png',
        alt: 'Service illustration photo',
      },
      cta: {
        actionConfig: {
    ...
    },
    {
      ...
      picture: {
        resourceRef: 'Depositphotos_169507418_original.png',
        alt: 'Service illustration photo',
      },
      cta: {
        actionConfig: {
